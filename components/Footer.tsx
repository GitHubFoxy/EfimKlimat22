            ...
            <Dialog>
              ...
              <DialogContent className="sm:max-w-xl max-h-[80vh] overflow-y-auto">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Настоящая Политика конфиденциальности персональных данных (далее – Политика) действует в отношении всей информации, которую Интернет-магазин {CompanyName || "[Название вашего магазина]"}, расположенный на доменном имени [Ваш домен], может получить о Пользователе во время использования сайта.
                  </DialogDescription>
                </DialogHeader>
