export default function WhyUs() {
  ...
  return (
    <div className="flex flex-col gap-6 mb-[120px]">
      <h1 className="font-[500] text-3xl text-center mb-6">
        Почему выбирают нас
      </h1>
      <div className="grid grid-cols-4 gap-4 items-start">
        {array.map((e, index) => {
          return (
            ...
            >
              <p className="text-5xl font-[500] text-light-orange">{e.part1}</p>
              <p className="text-blackish font-[400] text-[16px]">{e.part2}</p>
            </div>
          );
        })}
      </div>
