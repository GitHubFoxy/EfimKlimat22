...
export default function BestDeals() {
  ...
  return (
    <div className="flex flex-col mb-32">
      <h1 className="text-3xl font-[500] text-center mb-6">
        Выгодные предложения
      </h1>
      <div className="mb-4 border-b-2 pb-4 border-light-gray flex relative items-center justify-center">
        <Button className="absolute right-0 bg-light-orange">
          Смотреть все
        </Button>
        <Button
          variant={"secondary"}
          className="text-base font-[700] text-black bg-transparent"
        >
          Хиты продаж
        </Button>
        <Button
          variant={"secondary"}
          className="text-base font-[400] text-black bg-transparent"
        >
          Новинки
        </Button>
        <Button
